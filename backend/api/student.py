...
def list_rooms():
    ...
    result = room_service.list_rooms(room_type=room_type, is_active=True)
...
def list_seats(room_id):
    ...
    result = room_service.get_room_seats(room_id)
    if not result:
...
def search_seats():
    ...
    # TODO: 实现参数解析并调用 room_service.search_seats
...
def create_reservation():
    """提交座位预约"""
    data = request.get_json() or {}
    # TODO: 实现参数解析并调用 reservation_service.create_reservation
...
def cancel_reservation(id):
    ...
    # TODO: 调用 reservation_service.cancel_reservation
    return success_response(data=None)
...
def check_in(id):
    ...
    # TODO: 调用 reservation_service.check_in
...
def list_violations():
    """我的违约记录"""
    user_id = get_current_user_id()
    # TODO: 调用 reservation_service.list_user_violations
    return success_response(data={'items': []})
